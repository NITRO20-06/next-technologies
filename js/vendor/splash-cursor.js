...
// Source: https://github.com/xiqi/splash-cursor-effect-vanilla-js (ReactBits)
...
(function () {
  ...
  const BACK_COLOR = { r: 0.03, g: 0.06, b: 0.09 };
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateColor() {
      // Tonos cian/teal alineados con NEXT TECHNOLOGIES
      const c = HSVtoRGB(0.48 + Math.random() * 0.1, 0.85, 1.0);
      c.r *= 0.18;
      c.g *= 0.18;
      c.b *= 0.18;
      return c;
